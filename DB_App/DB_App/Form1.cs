        ...
        private void textBox7_TextChanged(object sender, EventArgs e)
        {
            try {
                ...
                (dataGridView1.DataSource as DataTable).DefaultView.RowFilter = string.Format(
                    "Convert(VIN_vehicle_number, 'System.String') LIKE '%{0}%' OR Convert(ID_vehicle_model, 'System.String') LIKE '%{0}%' OR Convert(Year_of_vehicle, 'System.String') LIKE '%{0}%' OR Convert(Car_color, 'System.String') LIKE '%{0}%' OR Convert([Engine_type], 'System.String') LIKE '%{0}%' OR Convert(Car_price, 'System.String') LIKE '%{0}%'",
                    searchString);
            }
            catch(Exception ex)
            {
